...
function EditorInner() {
  ...
  const nodesForRender = useMemo(
    ...
    [nodes, commentCounts, childrenMap, descendantsMap, toggleCollapse, hiddenNodeIds, searchQuery],
  );
  ...
  }, [contextMenu, rf, copyNode, cutNode, pasteNode, duplicateNode, removeNode, reorderNode, toggleCollapse]);
    ...
    <div className="h-screen w-screen flex flex-col bg-[#FDFBF7] overflow-hidden">
      ...
      <div className="flex-1 relative" ref={flowWrapper} data-testid="canvas-area" onMouseMove={onCanvasMouseMove}>
        <ReactFlow
          ...
          onPaneClick={() => { setSelectedNodeId(null); setContextMenu(null); setShowExportMenu(false); setSearchQuery(""); }}

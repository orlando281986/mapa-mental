...
async def upload_image(
    ...
    if ext not in {".png", ".jpg", ".jpeg", ".gif", ".webp", ".svg", ".mp4", ".webm", ".mov", ".avi"}:
        raise HTTPException(status_code=400, detail="Formato não suportado. Use PNG, JPG, GIF, WebP, SVG, MP4, WebM, MOV ou AVI.")

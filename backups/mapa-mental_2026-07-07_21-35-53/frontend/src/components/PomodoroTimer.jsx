    ...
    intervalRef.current = setInterval(() => {
      setTime((t) => {
        if (t <= 1) {
          ...
          const msg = next === "focus" ? "Pausa terminada! Hora de focar." : "Foco terminado! Hora de pausa.";
          toast(msg, { style: { fontSize: "1.25rem", padding: "16px 24px", fontWeight: 700 }, duration: 6000 });
          return dur * 60;
        }
        return t - 1;
      });
